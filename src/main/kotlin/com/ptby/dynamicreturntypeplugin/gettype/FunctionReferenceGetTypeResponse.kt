...
open class FunctionReferenceGetTypeResponse protected constructor(private val isNull: Boolean,
    ...
    override fun getSignature(): String {
        ...
        val reference = originalReference?.signature as String
    ...
    private fun convertParameters(originalReference: FunctionReference): String {
        ...
        if (originalReference.parameters.isEmpty()) {
            return parameters
        }


        for ((index, parameter) in originalReference.parameters.withIndex()) {
...
class FunctionGetTypeResponse(responseIsNull: Boolean,
                              originalReference: FunctionReference) :
